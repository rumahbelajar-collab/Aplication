...
export default function App() {
  ...
  const handleUpdateDb = (newDb: Database) => {
    const sanitized = ensureDatabaseDefaults({
      ...newDb,
    ...
    // Simpan lokal terlebih dahulu. Cloud sync berjalan setelahnya agar
    // kegagalan koneksi tidak membuat perubahan pengguna hilang.
    void pushToSupabase(sanitized);
  };
  ...
  const handleAdminSessionSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(error instanceof Error ? error.message : "Gagal menyimpan riwayat sesi.");
    }
  };
          ...
          {!userSession ? (
            <div id="login-screen" className="flex-1 flex flex-col justify-center items-center p-6 animate-fade-in my-auto">
              ...
              <div className="text-center mb-6">
                ...
                <h1 className="text-2xl font-extrabold tracking-tight font-display text-blue-800">
                  Let's   
